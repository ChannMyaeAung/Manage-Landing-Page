...
const Footer = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center gap-10 px-4 py-12 bg-VeryDarkBlue text-VeryLightGray">
      {/* Subscription */}
      <div id="subscription" className="flex gap-3">
        <label htmlFor="subscription">
          <input
            ...
            id="subscription"
            name="subscription"
            className="px-6 py-3 text-sm rounded-full placeholder:text-DarkGrayishBlue text-BrightRed"
          />
        </label>
        <button className="shadow-none hover:shadow-none cta__button">
          Go
        </button>
      </div>
      {/* Footer useful links */}
      <div className="flex justify-center w-full gap-12 font-light ">
        <ul className="flex flex-col gap-6 text-VeryLightGray">
          {leftLinks.map((link) => (
            <li
              key={link.id}
              className="transition-all hover:text-BrightRed focus:text-BrightRed"
            >
